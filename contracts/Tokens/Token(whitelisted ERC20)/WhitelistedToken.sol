...
contract BasicToken is ERC20Basic {
    ...
    modifier isInvestorApproved(address investor) {
        require(Whitelist(whitelistAddress).isInvestorApproved(investor), "Investor not whitelisted");
        _;
    }
    ...
    */
    function transfer(
        ...
        public 
        isInvestorApproved(msg.sender)
        isInvestorApproved(_to)
        returns (bool) 
    {
...
/** @title Token */
contract WhitelistedToken is DetailedERC20, MintableToken {
