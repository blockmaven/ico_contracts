...
import "../EthFeeEssentials/ERC223MintableTokenEthFee.sol";
import "../../Essentials/Validator.sol";
import "../../Whitelist/Whitelist.sol";


/** @title Compliant Token */
contract CompliantTokenEthFee is Validator, MintableToken {
    ...
    * @param data data in bytes in case receiving address is a contract
    */
    ...
    */
    ...
    constructor(
        ...
        public
        MintableToken(_owner, _name, _symbol, _decimals)
        Validator()
    {
    ...
    /** @dev transfer
      * @param _to address to which the tokens have to be transferred
      * @param _value amount of tokens to be transferred
      * @param _data data in bytes in case the receiving address is a contract
      */
        ...
        returns (bool)
    {
        ...
        emit RecordedPendingTransaction(
            msg.sender, 
            _to, 
            _value, 
            msg.value, 
        ...
        returns (bool)
    {
        ...
        emit RecordedPendingTransaction(_from, _to, _value, msg.value, msg.sender, currentNonce, empty);
        currentNonce++;
    ...
    {   
        ...
        bytes memory data = pendingTransactions[nonce].data;
        ...
        checkIsAddressValid(pendingTransactions[nonce].from)
    {
        ...
        emit TransferRejected(
            ...
            nonce,
            reason,
            pendingTransactions[nonce].data
        );
